    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = category.categoryDescription),
...
@Composable
private fun ListImageItem(category: Category, modifier: Modifier){
    Box(
        modifier = modifier
    ) {
        Image(
            painter = painterResource(id = category.avatar),
